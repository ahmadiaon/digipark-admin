...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="/financial/{{ $financial->id }}" method="post" id="main_form">
                @method('put')
                @csrf
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            <input autofocus name="name" class="form-control   @error('name') is-invalid @enderror"
                                value="{{ old('name',$financial->name) }}" type="text" placeholder="Masukan Nama Bank">
                            @error('name')
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="description"
                                class="form-control  @error('description') is-invalid @enderror">{{  old('description',$financial->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="address" type="text"
                                ...
                                value="{{ old('name',$financial->address) }}">
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="province" type="text"
                                ...
                                value="{{ old('province',$financial->province) }}">
                            @error('province')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="location" type="text"
                                ...
                                value="{{ old('location',$financial->location) }}">
                            @error('location')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="instagram" type="text"
                                ...
                                value="{{ old('instagram',$financial->instagram) }}">
                            @error('instagram')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="facebook" type="text"
                                ...
                                value="{{ old('facebook',$financial->facebook) }}">
                            @error('facebook')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="youtube" type="text"
                                ...
                                value="{{ old('youtube',$financial->youtube) }}">
                            @error('youtube')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select required name="status" class="form-control  @error('status') is-invalid @enderror">
                                <option value="1" {{ (old("status",$financial->status) == "1" ? "selected":"") }}>Aktif
                                </option>
                                <option value="0" {{ (old("status",$financial->status) == "0" ? "selected":"") }}>Tidak
                                    Aktif</option>
                            </select>
                            @error('status')
                            <div class="invalid-feedback">
