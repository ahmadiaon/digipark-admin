...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="">
            ...
            <form action="/gallery/{{ $gallery->id }}" method="post" id="main_form" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col col-lg-8">
                                                <img  class="rounded mt-3 img-thumbnail d-block"  id="showImage" src="http://digipark-admin.test/{{ $gallery->path }}" alt="" >
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="status" class="custom-select col-12">
                                <option {{ $gallery->status == 1 ? "selected" :""  }} value="1" selected="">Aktif</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required value="{{ old('name', $gallery->name) }}" name="name" type="text" class="form-control @error('name') is-invalid @enderror">
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
