        ...
        @foreach($galleries as $gallery)
            ...
            <div class="da-card box-shadow">
                <div class="da-card-photo">
                    <img src="http://digipark-admin.test/{{ $gallery->path }}" alt="">
                    <div class="da-overlay">
                        <div class="da-social">
                        <h5 class="mb-10 color-white pd-20">{{ $gallery->name }}</h5>
                            <ul class="clearfix">
                                <li><a href="http://digipark-admin.test/{{ $gallery->path }}" data-fancybox="images"><i class="fa fa-picture-o"></i></a></li>
                                <li><a href="/gallery/{{ $gallery->id}}/edit"><i class="icon-copy dw dw-pencil-1"></i></a></li>
                                <li>
                                    <a nohref  onclick="myFunction({{ $gallery->id }})">
                                        <form action="/gallery/{{ $gallery->id }}" method="post" class="d-inline">
                                           ...
                                           <i class="icon-copy dw dw-trash"></i>
                                             <button id="subs{{ $gallery->id }}" class="btn btn-outline-none text-decoration-none" onclick="return confirm('Are You Sure?')" ></button>
                                        </form>
                                    </a>
                                </li>
                ...
                <div class="da-card-content">
                    <h5 class="h5 mb-10">{{ $gallery->name }}</h5>
                    <p class="mb-0">Lorem ipsum dolor sit aaaa</p>
                </div>
            </div>
        </li>
        @endforeach
