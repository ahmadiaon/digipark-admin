...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="">
            ...
            <form action="/community-category/{{ $category->id }}" method="post" id="main_form">
                @method('put')
                @csrf
                   <div class="form-group">
                    <label>Nama Media</label>
                    <input autofocus name="category" class="form-control   @error('category') is-invalid @enderror" value="{{ old('category',$category->category) }}" type="text">
                    @error('category')
