...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="">
            ...
            <form action="/slide" method="post" id="main_form">
                   @csrf
                   <div class="form-group">
                    <label>Nama Media</label>
                    <input autofocus name="title" class="form-control   @error('title') is-invalid @enderror" value="{{ old('title') }}" type="text" placeholder="Masukan Nama Lengkap" >
                    @error('title')
