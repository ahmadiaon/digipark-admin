...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="">
            ...
            <form action="/slide/{{ $slide->id }}" method="post" id="main_form">
                @method('put')
                @csrf
                   <div class="form-group">
                    <label>Nama Media</label>
                    <input autofocus name="title" class="form-control   @error('title') is-invalid @enderror" value="{{ old('title',$slide->title) }}" type="text" placeholder="Masukan Nama Lengkap" >
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <select name="gallery_uuid" class="custom-select2 form-control  @error('gallery') is-invalid @enderror" name="state" style="width: 100%; height: 38px;">
                ...
                <div class="form-group ">
                    ...
                    <select name="status" class="form-control  @error('status') is-invalid @enderror">
                        ...
                        <option value="0" {{ (old("status",$slide->status) == "0" ? "selected":"") }}>Tidak Aktif</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">
                            {{ $message }}
