					...
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form action="/login" method="post">
							...
							<div class="input-group custom">
								<input value="{{ old('username') }}"  required autofocus name="username" type="text" class="form-control form-control-lg @error('username') is-invalid @enderror" placeholder="Username">
