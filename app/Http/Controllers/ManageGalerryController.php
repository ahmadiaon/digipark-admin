...
class ManageGalerryController extends Controller
{
    ...
    public function anyData()
    {
        return Datatables::of(Gallery::latest())
            ...
            ->addColumn('path', function ($model) {
                return '<img src="http://digipark-admin.test/' . $model->path . '" class="img-fluid" alt="...">';
            })
    ...
    public function store(Request $request)
    {
        ...
        $request->content->move(public_path('images/media'), $imageName);
        ...
        return redirect('/gallery')->with('success', 'New Gallery Inserted!');
    }
    ...
    public function update(Request $request, Gallery $gallery)
    {
        ...
        */
        ...
        return redirect('/gallery')->with('success', 'Proses Success!');
    }
    ...
    public function destroy(Gallery $gallery)
    {
        ...
        return redirect('/gallery/')->with('success', 'Post has been Deleted!');
    }
}
